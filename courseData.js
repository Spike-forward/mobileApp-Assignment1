// 課程資料介面定義 (JavaScript version)
// Note: This is a JavaScript version of the TypeScript file for browser compatibility
...
// 搜尋和篩選功能相關的函數
export function searchCourses(searchTerm, category = '') {
